(function($){
	...
	var testimonialsSwiperStyleTwo = new Swiper(".testimonialsSwiperStyleTwo .swiper", {
        spaceBetween: 25,
        grabCursor: true,
        loop: true,
        autoplay: {
    ...
    $(document).ready(function() {
        ...
        if (savedDirection === 'rtl') {
            $('#bootstrapStylesheet').attr('href', 'assets/css/bootstrap.rtl.min.html');
            $('html').attr('dir', 'rtl');
        } else {
        ...
        $('#toggleBootstrapDirection').click(function() {
            ...
            if (currentHref.includes('bootstrap.min.html') && !currentHref.includes('rtl')) {
                // Switch to RTL
                $('#bootstrapStylesheet').attr('href', 'assets/css/bootstrap.rtl.min.html');
                $('html').attr('dir', 'rtl');
        ...
        const themeSettingsHTML = `
            <div class="theme-settings-menu">
                <ul class="p-0 m-0 list-unstyled">
                    <li>
                        <a href="mailto:subupee@gmail.com" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Hire Us">
